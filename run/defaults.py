...
drfacs=[0.05,0.1,0.2,0.4] # Fraction of shell radius to use for shell thickness (r-dr/2 - r+dr/2)
dzfacs=[0.2,0.4,0.8] # Fraction of slab height to use for slab thickness (z-dz/2 - z+dz/2)
