    ...
    for igal,galaxy_snapf in subcat_selection_final.iterrows():
        ...
        if progid and np.nansum(progmatch) and central:
            ...
            if success:
                ...
                ### r200 facs
                r200_facs=[0.1,0.15,0.2,0.25,0.5,0.75,1,1.5,2]
                ...
                logging.info(f"Eulerian w trcs: {gasflow_irad_euler['inflowfluxtcrs-m']:.2e} Msun/Gyr")
                ...
                logging.info(f"Eulerian w trcs: {gasflow_irad_euler['000kmps_outflowfluxtcrs-m']:.2e} Msun/Gyr")
