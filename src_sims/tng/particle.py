...
# --------------------------------------------------------------------------------------
def read_subvol(path, ivol, nslice, metadata, logfile=None, verbose=False, maxifile=None, gasonly=False, buffer=2):
    """
    ...
    # ------------------------------------------------------------------
    lims = get_limits(ivol, nslice, boxsize, buffer=buffer)
